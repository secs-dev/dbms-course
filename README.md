...
**Note**. При невыполнении одного из требований из порядка выполнения и сдачи
...
**Note**. Возможно, вы будете не согласны с некоторыми ошибками линтера.
...
**Note**. Данный этап является опциональным. Ревью является возможностью
